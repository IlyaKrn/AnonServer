...
import com.example.anonserver.jwt.JwtAuthentication;
import com.example.anonserver.jwt.JwtProvider;
...
public class AuthService {
    ...
    public JwtResponse login(@NonNull JwtRequest authRequest) throws AuthException {
        final UserModel user = userService.getByLogin(authRequest.getUsername())
